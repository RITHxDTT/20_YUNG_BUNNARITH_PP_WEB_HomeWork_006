...
export default function Productcomponent({product}) {
    console.log(product);
    return (
        <div className=" shadow-2xl   w-[350px] h-[600px] flex flex-col rounded-2xl  border-[gray] justify-between">
            {/* img */}
            ...
            <div className='p-[15px] flex flex-col gap-3'>
                ...
                <Link href={`/product/${product.productId}`} className=' hover:cursor-pointer w-[100%] text-white font-bold h-[45px] flex justify-center items-center bg-[#0a023d] rounded-2xl'>
