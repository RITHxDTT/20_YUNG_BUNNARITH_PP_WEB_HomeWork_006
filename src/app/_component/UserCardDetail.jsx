    ...
    <div className="flex items-center justify-center min-h-screen p-[24px]">
      <div className="flex bg-white shadow-2xl w-[850px] h-[500px] rounded-[40px]">
        ...
        <div className="flex-1 p-[48px]">
          <Link
            href="/customer"
            className="text-[11px] font-bold flex items-center gap-[8px] tracking-[2px] text-[#94a3b8] uppercase mb-[40px] hover:text-slate-600 transition-colors"
          >
          ...
          <div className="flex flex-wrap gap-y-[40px] mb-[48px]">
            <div className="w-[220px]">
              ...
              <div className="flex items-center gap-[8px]">
                ...
                <span className="font-[800] text-[#334155]">{customer.firstName} {customer.lastName}</span>
              </div>
            </div>
            ...
            <div className="w-[220px]">
              ...
              <div className="flex items-center gap-[8px]">
                ...
                <span className="text-[24px] font-[900] text-[#1e293b]">${customer.moneySpent}</span>
              </div>
            </div>
            ...
            <div className="w-[220px]">
              ...
              <div className="flex items-center gap-[8px]">
                ...
                <span className="font-[800] text-[#334155]">{customer.birthDate}</span>
              </div>
            </div>
